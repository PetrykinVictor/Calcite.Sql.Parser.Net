...
namespace Calcite.Sql.Parser.Net
{
	...
	sealed class SqlKindAttribute : Attribute
	{
		public string Name { get; }
		public SqlKindAttribute(string name)
		{
			this.Name = name;
		}
	...
	/**
	 * Enumerates the possible types of <see cref="SqlNode"/>
	 *
	...
	{	
		...
		/**
		 * Expression not covered by any other <see cref="SqlKind"/> value.
		 *
		 * <seealso cref="OTHER_FUNCTION"/>
		 */
		OTHER,
	...
	public static class SqlKindCategories
	{
		/**
		* Category consisting of set-query node types.
		*
		* <p>Consists of:
		* <see cref="SqlKind.UNION"/>,
		* <see cref="SqlKind.INTERSECT"/>,
		* <see cref="SqlKind.EXCEPT"/>,
		*/
		public static ICollection<SqlKind> SET_QUERY =
			new List<SqlKind> { SqlKind.UNION, SqlKind.INTERSECT, SqlKind.EXCEPT };

		/// <summary>
		/// Category consisting of all built-in aggregate functions.
		/// </summary>
		public static ICollection<SqlKind> AGGREGATE =
			new List<SqlKind> {
					SqlKind.COUNT, SqlKind.SUM, SqlKind.SUM0, SqlKind.MIN, SqlKind.MAX,
					SqlKind.LEAD, SqlKind.LAG, SqlKind.FIRST_VALUE, SqlKind.LAST_VALUE,
					SqlKind.COVAR_POP, SqlKind.COVAR_SAMP, SqlKind.REGR_COUNT, SqlKind.REGR_SXX,
					SqlKind.REGR_SYY, SqlKind.AVG, SqlKind.STDDEV_POP, SqlKind.STDDEV_SAMP, SqlKind.VAR_POP,
					SqlKind.VAR_SAMP, SqlKind.NTILE, SqlKind.COLLECT, SqlKind.FUSION,
					SqlKind.SINGLE_VALUE, SqlKind.ROW_NUMBER, SqlKind.RANK, SqlKind.PERCENT_RANK,
					SqlKind.DENSE_RANK, SqlKind.CUME_DIST, SqlKind.JSON_ARRAYAGG, SqlKind.JSON_OBJECTAGG,
					SqlKind.BIT_AND, SqlKind.BIT_OR
			};
	   ...
	   */
		public static ICollection<SqlKind> DML =
			new List<SqlKind> { SqlKind.INSERT, SqlKind.DELETE, SqlKind.UPDATE, SqlKind.MERGE, SqlKind.PROCEDURE_CALL };

		/// <summary>
		/// Category consisting of all DDL operators.
		/// </summary>
		public static ICollection<SqlKind> DDL =
			new List<SqlKind> { SqlKind.COMMIT, SqlKind.ROLLBACK, SqlKind.ALTER_SESSION,
		...
		* {@link #EXPLICIT_TABLE}.
		*/
		public static ICollection<SqlKind> QUERY =
			new List<SqlKind> { SqlKind.SELECT, SqlKind.UNION, SqlKind.INTERSECT,
				SqlKind.EXCEPT, SqlKind.VALUES, SqlKind.WITH, SqlKind.ORDER_BY,
		...
		*/
		public static ICollection<SqlKind> EXPRESSION =
			new List<SqlKind> { SqlKind.AS, SqlKind.ARGUMENT_ASSIGNMENT, SqlKind.DEFAULT,
						SqlKind.RUNNING, SqlKind.FINAL, SqlKind.LAST, SqlKind.FIRST, SqlKind.PREV, SqlKind.NEXT,
						SqlKind.DESCENDING, SqlKind.CUBE, SqlKind.ROLLUP, SqlKind.GROUPING_SETS, SqlKind.EXTEND, SqlKind.LATERAL,
						SqlKind.SELECT, SqlKind.JOIN, SqlKind.OTHER_FUNCTION, SqlKind.POSITION, SqlKind.CAST, SqlKind.TRIM,
						SqlKind.FLOOR, SqlKind.CEIL, SqlKind.TIMESTAMP_ADD, SqlKind.TIMESTAMP_DIFF, SqlKind.EXTRACT,
						SqlKind.LITERAL_CHAIN, SqlKind.JDBC_FN, SqlKind.PRECEDING, SqlKind.FOLLOWING, SqlKind.ORDER_BY,
						SqlKind.NULLS_FIRST, SqlKind.NULLS_LAST, SqlKind.COLLECTION_TABLE, SqlKind.TABLESAMPLE,
						SqlKind.VALUES, SqlKind.WITH, SqlKind.WITH_ITEM, SqlKind.SKIP_TO_FIRST, SqlKind.SKIP_TO_LAST,
						SqlKind.JSON_VALUE_EXPRESSION, SqlKind.JSON_API_COMMON_SYNTAX }
					.Concat(AGGREGATE)
					.Concat(DML)
					.Concat(DDL);
		...
		*/
		public static ICollection<SqlKind> TOP_LEVEL =
			new List<SqlKind>(QUERY)
				.Concat(DML)
				.Concat(DDL);
		...
		*/
		public static ICollection<SqlKind> FUNCTION =
			new List<SqlKind> { SqlKind.OTHER_FUNCTION, SqlKind.ROW, SqlKind.TRIM, SqlKind.LTRIM, SqlKind.RTRIM,
								SqlKind.CAST, SqlKind.JDBC_FN, SqlKind.POSITION };
		 ...
		 */
		public static ICollection<SqlKind> AVG_AGG_FUNCTIONS =
			new List<SqlKind> { SqlKind.AVG, SqlKind.STDDEV_POP, SqlKind.STDDEV_SAMP, SqlKind.VAR_POP, SqlKind.VAR_SAMP };
		 ...
		 * {@link #REGR_SYY}.
		 */
		public static ICollection<SqlKind> COVAR_AVG_AGG_FUNCTIONS =
			new List<SqlKind> { SqlKind.COVAR_POP, SqlKind.COVAR_SAMP, SqlKind.REGR_COUNT, SqlKind.REGR_SXX, SqlKind.REGR_SYY };
		...
		*/
		public static ICollection<SqlKind> COMPARISON =
			new List<SqlKind> {
				SqlKind.IN, SqlKind.EQUALS, SqlKind.NOT_EQUALS,
	...
	public static class SqlKindHelpers
	{

		public static ICollection<SqlKind> Concat(this ICollection<SqlKind> original, ICollection<SqlKind> other)
		{
		...
		public static bool BelongsTo(this SqlKind sqlKind, ICollection<SqlKind> category)
		{
			return category.Contains(sqlKind);
		}

		public static SqlKind Reverse(this SqlKind sql)
		{
			switch (sql)
			{
		...
		*/
		public static SqlKind Negate(this SqlKind sql)
		{
			switch (sql)
			{
				case SqlKind.IS_TRUE:
					return SqlKind.IS_NOT_TRUE;
				case SqlKind.IS_FALSE:
					return SqlKind.IS_NOT_FALSE;
				case SqlKind.IS_NULL:
					return SqlKind.IS_NOT_NULL;
				case SqlKind.IS_NOT_TRUE:
					return SqlKind.IS_TRUE;
				case SqlKind.IS_NOT_FALSE:
					return SqlKind.IS_FALSE;
				case SqlKind.IS_NOT_NULL:
					return SqlKind.IS_NULL;
				case SqlKind.IS_DISTINCT_FROM:
					return SqlKind.IS_NOT_DISTINCT_FROM;
				case SqlKind.IS_NOT_DISTINCT_FROM:
					return SqlKind.IS_DISTINCT_FROM;
				default:
					return sql;
			}
		}
		...
		* </ul>
		*/
		public static SqlKind NegateNullSafe(this SqlKind sql)
		{
			switch (sql)
			{
				case SqlKind.EQUALS:
		...
		public static string GetName(this SqlKind sqlKind)
		{
			var attribute =
					sqlKind.GetType()
						.GetTypeInfo()
						.GetMember(sqlKind.ToString())
						.FirstOrDefault(field => field.MemberType == MemberTypes.Field)
						.GetCustomAttributes(typeof(SqlKindAttribute), false)
						.SingleOrDefault()
						as SqlKindAttribute;

			return attribute?.Name ?? sqlKind.ToString();
		}
